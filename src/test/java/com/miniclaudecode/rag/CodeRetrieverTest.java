...
class CodeRetrieverTest {
    ...
    private static final String TEST_PROJECT = "/tmp/mini-claude-code-code-retriever";
    private VectorStore store;

    @BeforeEach
    void setUp() throws Exception {
        System.setProperty("mini-claude-code.rag.dir", "/tmp/mini-claude-code-test-rag-retriever");
