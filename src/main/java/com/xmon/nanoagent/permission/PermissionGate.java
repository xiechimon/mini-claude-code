...
public final class PermissionGate {
     ...
     */
    public PermissionGate(List<PermissionRule> rules, ApprovalPrompt approvalPrompt) {
     ...
     */
    public PermissionDecision check(PermissionMode mode, String toolName, JsonValue input) {
