...
import com.miniclaudecode.browser.BrowserAuditMetadata;
import com.miniclaudecode.browser.BrowserCheckResult;
import com.miniclaudecode.browser.BrowserConnector;
import com.miniclaudecode.browser.BrowserGuard;
import com.miniclaudecode.context.ContextProfile;
import com.miniclaudecode.lsp.LspDiagnosticReport;
import com.miniclaudecode.lsp.LspManager;
import com.miniclaudecode.mcp.protocol.McpToolDescriptor;
import com.miniclaudecode.policy.AuditLog;
import com.miniclaudecode.policy.CommandGuard;
import com.miniclaudecode.policy.PathGuard;
import com.miniclaudecode.policy.PolicyException;
import com.miniclaudecode.rag.CodeRetriever;
import com.miniclaudecode.rag.SearchResultFormatter;
import com.miniclaudecode.rag.VectorStore;
...
public class ToolRegistry {
    ...
    private static final Set<String> SEARCH_EXCLUDED_DIRS = Set.of(
            ".git", ".mini-claude-code", "target", "node_modules", "dist", "build", "coverage", ".idea", ".gradle"
    );
    ...
    public void setWriteFileObserver(java.util.function.BiConsumer<String, String[]> observer) {
        this.writeFileObserver = observer == null ? (p, ba) -> {
        } : observer;
    }
    ...
    private String globFiles(Map<String, String> args) {
        ...
        Path projectRoot = pathGuard.rootPath();
    ...
    public List<com.miniclaudecode.llm.LlmClient.Tool> getToolDefinitions() {
        return tools.values().stream()
                .map(t -> new com.miniclaudecode.llm.LlmClient.Tool(t.name(), t.description(), t.parameters()))
                .toList();
    }

    /**
     * @param descriptor namespacedName 形如 mcp__filesystem__read_file
     * @param invoker    输入 JSON 参数，输出直接回灌给 LLM 的文本
     */
    ...
    /**
     * 危险工具会记录 deny、error 或 allow 审计结果
     * allow 只表示调用已发生，不代表工具返回的业务结果成功
     */
    ...
    public List<ToolExecutionResult> executeTools(List<ToolInvocation> invocations) {
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread thread = new Thread(r, "mini-claude-code-tool-executor");
    ...
    private String executeCommand(String command) {
        ...
        ExecutorService outputReaderExecutor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "mini-claude-code-command-output");
            thread.setDaemon(true);
            return thread;
        });
    ...
    public record ToolExecutionResult(String id, String name, String argumentsJson,
                                      ...
                                      List<com.miniclaudecode.llm.LlmClient.ContentPart> imageParts) {
