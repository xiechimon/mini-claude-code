 ...
 * Inline 流式渲染器：默认形态
 *
 * <p>不进入 alternate screen，正文留在主屏滚动
 * JLine 管理输入行和底部状态区，无法行内呈现的交互回退到 {@link PlainRenderer}
 */
public final class InlineRenderer implements Renderer {
    ...
    /**
     * 在首屏完成 printAbove 后执行一次回调，用于启动不得抢在 Logo 前输出的后台任务
     */
    public void installStartupScreen(List<String> lines, Runnable afterDisplay) {
