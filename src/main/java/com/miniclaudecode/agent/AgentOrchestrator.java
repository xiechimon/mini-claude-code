...
public class AgentOrchestrator {
    ...
    /**
     * 所有角色共享同一 SkillRegistry 和 SkillContextBuffer
     */
    public void setSkillSystem(com.miniclaudecode.skill.SkillRegistry skillRegistry,
                               com.miniclaudecode.skill.SkillContextBuffer skillContextBuffer) {
    ...
    /**
     * 格式异常或缺少 approved 字段时默认拒绝，避免错误结果被放行
     */
    ...
    private void runBatchParallel(List<ExecutionStep> batch, List<ExecutionStep> steps,
        ...
        ExecutorService executor = Executors.newFixedThreadPool(parallelism, r -> {
            Thread t = new Thread(r, "mini-claude-code-multi-agent");
            t.setDaemon(true);
            return t;
        });
