...
import com.miniclaudecode.mcp.mention.AtMentionCompleter;
...
/**
 * 汇总 slash 命令、Skill、MCP resource 和本地路径的 JLine 补全候选
 */
final class MiniClaudeCodeCompleter implements Completer {
    private final Supplier<List<McpResourceDescriptor>> resourceSupplier;
    private final Supplier<List<Skill>> skillSupplier;

    MiniClaudeCodeCompleter(Supplier<List<McpResourceDescriptor>> resourceSupplier) {
