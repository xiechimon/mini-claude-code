...
import com.miniclaudecode.hitl.HitlHandler;
...
import com.miniclaudecode.tui.history.ConversationSnapshot;
...
public final class TuiSessionController implements AutoCloseable {
    ...
    public TuiSessionController(MiniClaudeCodeConfig config,
                                LlmClient llmClient,
                                Agent reactAgent,
        ...
        this.executor = Executors.newSingleThreadExecutor(r -> {
            Thread thread = new Thread(r, "mini-claude-code-tui-agent-runner");
