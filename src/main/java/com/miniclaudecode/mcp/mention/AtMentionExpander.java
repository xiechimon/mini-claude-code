package com.miniclaudecode.mcp.mention;
...
/**
 * 将 MCP resource mention 展开为受字符预算限制的 XML 上下文块
 * 失败时保留原引用并附加结构化错误
 */
    ...
    private String expandToken(AtMentionParser.MentionToken token) {
        try {
            ...
            String suffix = truncated
                    ? "\n[resource truncated by Mini Claude Code at " + MAX_INLINE_RESOURCE_CHARS + " chars]"
                    : "";
