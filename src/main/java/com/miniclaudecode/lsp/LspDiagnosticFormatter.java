...
public final class LspDiagnosticFormatter {
    ...
    static int maxDiagnostics() {
        String property = System.getProperty("mini-claude-code.lsp.max.diagnostics");
        if (property == null || property.isBlank()) {
            property = System.getenv("MINI_CLAUDE_CODE_LSP_MAX_DIAGNOSTICS");
        }
        if (property == null || property.isBlank()) {
